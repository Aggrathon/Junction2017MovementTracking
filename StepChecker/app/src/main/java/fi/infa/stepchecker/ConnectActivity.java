...
public class ConnectActivity extends AppCompatActivity implements AdapterView.OnItemLongClickListener, AdapterView.OnItemClickListener {
    ...
    public void onScanClicked(View view) {
        findViewById(R.id.buttonScan).setBackgroundColor(Color.CYAN);
        findViewById(R.id.buttonScanStop).setBackgroundColor(Color.LTGRAY);
    ...
    public void onScanStopClicked(View view) {
        ...
        findViewById(R.id.buttonScan).setBackgroundColor(Color.LTGRAY);
        findViewById(R.id.buttonScanStop).setBackgroundColor(Color.CYAN);
    }
